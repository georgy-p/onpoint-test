...
const TextSlide = () => {
  return (
    <div className='text-slide-container'>
      <div className='corner-text-box'>
        <p className='corner-text'>ТЕКСТ</p>
        <p className='corner-text'>СООБЩЕНИЯ</p>
      </div>
      <div className='text-scroll-box'>
        <div className='text-scroll-container'>
          <div className='text-scroll-inner-container'>
            <p className='text-scroll-text'>
              <span className='text-scroll-text-bold'>
